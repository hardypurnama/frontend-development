...
const AddUser = (props) => {
  ...
  const postDataToAPI = () => {
    axios
      .post("https://backend-recruitment-production.up.railway.app/users/register", user, {
        headers: authHeader(),
      })
      .then(
        (res) => {
  ...
  const putDataToAPI = () => {
    axios
      .put(`https://backend-recruitment-production.up.railway.app/users/register/${user.id}`, user, {
        headers: authHeader(),
      })
      .then((res) => {
        handleReset();
